...
export const Route = createFileRoute("/lesson21")({ component: Lesson21 });

function Lesson21() {
  const { lang, completeLesson } = useApp();
  const lesson = getLesson("l21")!;

  return (
    <div className="space-y-4">
      <div className="rounded-3xl bg-gradient-to-br from-[oklch(0.72_0.18_210)] via-[oklch(0.68_0.2_200)] to-[oklch(0.64_0.22_190)] p-5 shadow-soft">
